...
class User implements IDBAccessObject, UserIdentity {
	...
	/**
	 * Get the boolean of the user's phone authentication
	 * @return boolean boolean
	 */
	public function getPhoneAuthenticationBoolean() {
		$this->load();
		Hooks::run( 'UserGetPhoneAuthenticationBoolean', [ $this, &$this->mPhoneAuthenticated ] );
		return $this->mPhoneAuthenticated;
	}
